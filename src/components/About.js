  ...
  render() {
    return (
      <div id="about">
        ...
        <p>W/ Jumble allows users to create poems and run them through a Markov generator, which uses an algorithim that splits a body of text into pieces the size of which is dictated by input into the function (i do this in the backend).</p>
        ...
        <p>W/ Jumble shares all poems through a community link.  This feature encourages users to collaborate in their creative endevors, and offers new users plenty of material to get started.</p>
      </div>
    )
  }
}
